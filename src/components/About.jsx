        ...
        <div className="bg-[var(--bg-color)] h-screen flex flex-row items-center justify-center gap-[90px]">
            ...
            <div className="flex flex-col w-1/3">
                ...
                <p className="text-[#6B7280] font-lexend font-normal p-3 px-0 text-md">
                    Passionate about technology and web development, I’m a junior programmer with a solid grounding in <strong className="font-bold text-[#FFF]">HTML, CSS, Tailwind, Bootstrap, React and Javascript.</strong> During my technical computer course, which I completed alongside high school, I learned how to turn ideas into practical, functional projects. I’m currently deepening my knowledge of <strong className="font-bold text-[#FFF]">JavaScript, React and TypeScript</strong>, expanding my skills to create dynamic and interactive applications.
                </p>
                <p className="text-[#6B7280] font-lexend font-normal p-3 px-0 text-md ">
                ...
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=nicksss.gomes@gmail.com&su=Contato&body=Olá,%20gostaria%20de%20falar%20com%20você." className="p-4 bg-(--head-bg) text-(--main-text) rounded-sm w-1/3 flex items-center justify-center font-lexend font-regular border hover:bg-(--button-color) border-solid hover:border-(--border-button) hover:shadow-(--shadow-button) transition-all duration-300 ease-in-out " target="blank">Contact Me</a>
