    ...
    <body className="bg-(--bg-color) overflow-hidden max-h-screen">
      ...
      <main className="flex items-center justify-center h-screen">
        ...
        <div className="text-(--main-text) max-w-2xl">
          ...
          <p className="font-poppins font-normal p-3 px-0 mb-10">
          ...
          <a href="" className="flex w-4/6 text-xl justify-center items-center gap-3 hover:text-(--bg-color) font-poppins font-bold bg-(--head-bg) hover:bg-(--button-color) p-6 border border-solid hover:border-(--border-button) rounded-sm hover:shadow-(--shadow-button) transition-all duration-300 ease-in-out">
            Let’s get started
